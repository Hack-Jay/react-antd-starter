...
// 企业基本信息页面
const EnterpriseCertification = loadable(() => import( /* webpackChunkName: 'enterprise-certification' */ '@/views/basicInfo/enterpriseCertification'))
const EnterpriseWebsite = loadable(() => import( /* webpackChunkName: 'enterprise-website' */ '@/views/basicInfo/enterpriseWebsite'))

// 工作台
const WorkBench = loadable(() => import( /* webpackChunkName: 'enterprise-website' */ '@/views/workBench'))
// 账号设置
const AccountSetting = loadable(() => import( /* webpackChunkName: 'enterprise-website' */ '@/views/setting'))

// 账号权限设置: auth: [] 1 管理员 2 超级管理员
const routes = [
    {
        path: '/index',
        exact: true,
    ...
    {
        path: '/basic-info/enterprise-certification',
        exact: false,
        name: '企业认证',
    ...
    {
        path: '/basic-info/enterprise-website',
        exact: false,
        name: '企业官网',
